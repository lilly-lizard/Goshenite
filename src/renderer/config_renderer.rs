...
pub const ENABLE_VULKAN_VALIDATION: bool = cfg!(debug_assertions); // todo apple... cfg!(debug_assertions); // pending https://github.com/KhronosGroup/Vulkan-ValidationLayers/issues/4891
